...
<head>
    ...
    <title>PBM (Program Belajar Mandiri) - PPDB biMBA AIUEO</title>
...
<body class="bg-[#FDFDFC] text-[#1b1b18] font-sans antialiased">
    ...
    <main class="pt-32 pb-20 px-6 max-w-4xl mx-auto">
        <div class="bg-blue-50 border border-blue-100 rounded-3xl p-8 md:p-12 mb-12">
            <div class="flex items-center gap-4 mb-6">
                <span class="text-6xl">🔬</span>
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900">PBM (Program Belajar Mandiri)</h1>
            </div>
            <p class="text-xl text-gray-700 leading-relaxed">
                Dikhususkan untuk anak usia 5-7 tahun yang sudah bersekolah atau memiliki kegiatan rutin pada pagi harinya.
            </p>
        </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3">
                        ...
                        3 kali pertemuan dalam seminggu, pada hari Senin, Rabu, dan Jumat.
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-500 font-bold">✓</span>
