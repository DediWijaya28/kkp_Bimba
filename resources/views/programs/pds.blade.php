...
<head>
    ...
    <title>PDS (Peserta Didik Standar)</title>
...
<body class="bg-[#FDFDFC] text-[#1b1b18] font-sans antialiased">
    ...
    <main class="pt-32 pb-20 px-6 max-w-4xl mx-auto">
        <div class="bg-red-50 border border-red-100 rounded-3xl p-8 md:p-12 mb-12">
            <div class="flex items-center gap-4 mb-6">
                <span class="text-6xl">🧸</span>
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900">PDS (Peserta Didik Standar)</h1>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-16">
            <div>
                <h2 class="text-2xl font-bold mb-6 flex items-center gap-3">
                    <span class="w-8 h-8 bg-red-100 text-red-600 rounded-lg flex items-center justify-center text-sm">01</span>
                    Detail Kelas
                </h2>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3">
                        <span class="text-green-500 font-bold">✓</span>
                        2 kali pertemuan dalam seminggu, pada hari Selasa dan Kamis.
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-500 font-bold">✓</span>
                    ...
                    <li class="flex items-start gap-3">
                        <span class="text-green-500 font-bold">✓</span>
                        Setiap 1 guru mengajar 4 murid.
                    </li>
                </ul>
            </div>
            <div>
                <h2 class="text-2xl font-bold mb-6 flex items-center gap-3">
                    <span class="w-8 h-8 bg-red-100 text-red-600 rounded-lg flex items-center justify-center text-sm">03</span>
                    Biaya Kelas
                </h2>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold mb-6 flex items-center gap-3">
                    <span class="w-8 h-8 bg-red-100 text-red-600 rounded-lg flex items-center justify-center text-sm">02</span>
                    Pilihan Jam Belajar
                </h2>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3">
                    ...
                    <li class="flex items-start gap-3">
                        <span class="text"></span>
                        • Sesi Siang (Dikhususkan untuk anak yang sudah bersekolah atau memiliki kegiatan rutin pada pagi harinya).
                    </li>
                    <li class="flex items-start gap-3">
                        <span class="text-green-500 font-bold">✓</span>
