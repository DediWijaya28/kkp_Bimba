            ...
            <div class="bg-white rounded-2xl shadow-sm border border-black-100 p-6 sticky top-24">
                ...
                <form action="{{ route('admin.classes.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" required placeholder="Contoh: Kelas A Pagi" class="w-full rounded-lg border-black-300 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-black-700 mb-1">Program</label>
                        <select name="program" class="w-full rounded-lg border-black-300 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-black-700 mb-1">Biaya (Rp)</label>
                        <input type="number" name="price" required min="0" value="0" class="w-full rounded-lg border-black-300 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="time" required placeholder="08:00 - 10:00" class="w-full rounded-lg border-black-300 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-black-700 mb-1">Kuota</label>
                        <input type="number" name="quota" required min="1" value="4" class="w-full rounded-lg border-black-300 focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                        ...
                        <thead class="bg-black-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-black-500 uppercase tracking-wider">Nama Kelas</th>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-black-500 uppercase tracking-wider">Biaya</th>
